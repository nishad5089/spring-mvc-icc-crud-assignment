    ...
    <div id="content">
        ...
        <table>
            ...
            <c:forEach var="tempPlayer" items="${team.players}">
                ...
                <c:url var="removelink" value="/team/removePlayer">
                    <c:param name="playerId" value="${tempPlayer.id}"/>

                    <c:param name="teamId" value="${tempPlayer.team.id}"/>
                ...
                <tr>
                    ...
                    <td> <a href="${updatelink}">update</a>
                        <a href="${removelink}" onclick="if (!(confirm('Are you sure you want to remove this  player from this team?'))) return false">|remove-from-Team</a>
                    </td>
                </tr>
